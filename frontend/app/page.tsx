...
export default function Home() {
  const { links,fetchLinks,fetchLinkStats,createLink} = useLinkStore();
  const handleclick=async()=>{
    // await fetchLinkStats("e6I959");
    await createLink({target_url:"",code:"asdfgh"})
    console.log("All links",useLinkStore.getState().links);
  }
  return (
